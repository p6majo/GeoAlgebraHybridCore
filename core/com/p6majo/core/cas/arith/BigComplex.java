...
import com.p6majo.core.cas.structure.GcdRingElem;
import com.p6majo.core.cas.structure.RingFactory;
import com.p6majo.core.cas.structure.StarRingElem;
...
public final class BigComplex implements StarRingElem<BigComplex>, GcdRingElem<BigComplex>,
     ...
     */
    public final com.p6majo.core.cas.arith.BigRational re;


    /**
     * Imaginary part of the data structure.
     */
    public final com.p6majo.core.cas.arith.BigRational im;


    private final static Random random = new Random();


    private static final Logger logger = new Logger(BigComplex.class);
     ...
     */
    public BigComplex(com.p6majo.core.cas.arith.BigRational r, com.p6majo.core.cas.arith.BigRational i) {
        re = r;
        im = i;
    }
     ...
     * @param r real part.
     */
    public BigComplex(com.p6majo.core.cas.arith.BigRational r) {
        this(r, com.p6majo.core.cas.arith.BigRational.ZERO);
    }
    ...
    public BigComplex(long r) {
        this(new com.p6majo.core.cas.arith.BigRational(r), com.p6majo.core.cas.arith.BigRational.ZERO);
    }
     ...
     */
    public BigComplex() {
        this(com.p6majo.core.cas.arith.BigRational.ZERO);
    }
    ...
    public BigComplex(String s) throws NumberFormatException {
        if (s == null || s.length() == 0) {
            re = com.p6majo.core.cas.arith.BigRational.ZERO;
            im = com.p6majo.core.cas.arith.BigRational.ZERO;
            return;
        }
        s = s.trim();
        int i = s.indexOf("i");
        if (i < 0) {
            re = new com.p6majo.core.cas.arith.BigRational(s);
            im = com.p6majo.core.cas.arith.BigRational.ZERO;
            return;
        }
        //com.p6majo.logger.warn("String constructor not done");
        String sr = "";
        if (i > 0) {
            sr = s.substring(0, i);
        }
        ...
        //int j = sr.indexOf("+");
        re = new com.p6majo.core.cas.arith.BigRational(sr.trim());
        im = new com.p6majo.core.cas.arith.BigRational(si.trim());
    }
    ...
    public BigComplex fromInteger(BigInteger a) {
        return new BigComplex(new com.p6majo.core.cas.arith.BigRational(a));
    }
     ...
     * The constant 1.
     */
    public static final BigComplex ONE = new BigComplex(com.p6majo.core.cas.arith.BigRational.ONE);


    /**
     * The constant i.
     */
    public static final BigComplex I = new BigComplex(com.p6majo.core.cas.arith.BigRational.ZERO, com.p6majo.core.cas.arith.BigRational.ONE);
     ...
     * @return re.
     */
    public com.p6majo.core.cas.arith.BigRational getRe() {
        return re;
    }
     ...
     * @return im.
     */
    public com.p6majo.core.cas.arith.BigRational getIm() {
        return im;
    }
    ...
    public String toString() {
        String s = "" + re;
        int i = im.compareTo(com.p6majo.core.cas.arith.BigRational.ZERO);
        //com.p6majo.logger.info("compareTo "+im+" ? 0 = "+i);
        if (i == 0)
            return s;
        s += "i" + im;
        return s;
        ...
        if (rz) {
            if (!im.isONE()) {
                if (im.signum() > 0) {
                    ...
                    s.append("-");
                    com.p6majo.core.cas.arith.BigRational ii = im.negate();
                    if (!ii.isONE()) {
    ...
    public BigComplex norm() {
        ...
        com.p6majo.core.cas.arith.BigRational v = re.multiply(re);
    ...
    public BigComplex abs() {
        BigComplex n = norm();
        logger.log(Logger.Level.warning,"abs() square root missing");
        // n = n.sqrt();
        return n;
    }
     ...
     */
    public static com.p6majo.core.cas.arith.BigRational CABS(BigComplex A) {
        if (A == null)
            return null;
        return A.abs().re;
    }
    ...
    public BigComplex inverse() {
        com.p6majo.core.cas.arith.BigRational a = norm().re.inverse();
    ...
    public BigComplex random(int n, Random rnd) {
        com.p6majo.core.cas.arith.BigRational r = com.p6majo.core.cas.arith.BigRational.ONE.random(n, rnd);
        com.p6majo.core.cas.arith.BigRational i = com.p6majo.core.cas.arith.BigRational.ONE.random(n, rnd);
    ...
    public BigComplex[] egcd(BigComplex S) {
        ...
        BigComplex half = new BigComplex(new com.p6majo.core.cas.arith.BigRational(1, 2));
        ret[0] = ONE;
