...
public /*final*/ class BigQuaternion implements StarRingElem<BigQuaternion>, GcdRingElem<BigQuaternion> {
    ...
    private static final Logger logger = new Logger(BigQuaternion.class);
    ...
    public String toString() {
        ...
        if (debug) {
            logger.log(Logger.Level.debug,"compareTo " + im + " ? 0 = " + i);
            logger.log(Logger.Level.debug,"compareTo " + jm + " ? 0 = " + j);
            logger.log(Logger.Level.debug,"compareTo " + km + " ? 0 = " + k);
        }
        if (i == 0 && j == 0 && k == 0) {
            return sb.toString();
        }
    ...
    public BigQuaternion abs() {
        ...
        logger.log(Logger.Level.error,"abs() square root missing");
        // n = n.sqrt();
        return n;
    }
