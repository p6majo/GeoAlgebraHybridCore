...
public final class BigRational implements GcdRingElem<BigRational>, RingFactory<BigRational>, Rational,
     ...
     * @param n com.p6majo.core.cas.arith.BigInteger.
     */
    public BigRational(com.p6majo.core.cas.arith.BigInteger n) {
        this(n.getVal());
    }
     ...
     * Constructor for a BigRational from jas.arith.BigIntegers.
     * @param n com.p6majo.core.cas.arith.BigInteger.
     * @param d com.p6majo.core.cas.arith.BigInteger.
     */
    public BigRational(com.p6majo.core.cas.arith.BigInteger n, com.p6majo.core.cas.arith.BigInteger d) {
     ...
     * @see com.p6majo.core.cas.arith.Rational#getRational()
     */
     ...
     * @return BigRational from a.
     */
    public BigRational fromInteger(com.p6majo.core.cas.arith.BigInteger a) {
        return new BigRational(a);
    }
...
class BigRationalIterator implements Iterator<BigRational> {
    ...
    com.p6majo.core.cas.arith.BigInteger den;


    com.p6majo.core.cas.arith.BigInteger num;


    Iterator<com.p6majo.core.cas.arith.BigInteger> denit;


    Iterator<com.p6majo.core.cas.arith.BigInteger> numit;


    List<com.p6majo.core.cas.arith.BigInteger> denlist;


    List<com.p6majo.core.cas.arith.BigInteger> numlist;


    Iterator<com.p6majo.core.cas.arith.BigInteger> denlistit;


    Iterator<com.p6majo.core.cas.arith.BigInteger> numlistit;
    ...
    public BigRationalIterator(boolean nn) {
        nonNegative = nn;
        curr = com.p6majo.core.cas.arith.BigRational.ZERO;
        level = 0;
        den = new com.p6majo.core.cas.arith.BigInteger(); // ZERO
        num = com.p6majo.core.cas.arith.BigInteger.ONE.copy();
        if (nonNegative) {
        ...
        denit = den.iterator();
        numit = num.iterator();
        denlist = new ArrayList<com.p6majo.core.cas.arith.BigInteger>();
        numlist = new ArrayList<com.p6majo.core.cas.arith.BigInteger>();
        com.p6majo.core.cas.arith.BigInteger unused = denit.next(); // skip zero denominator
        unused = numit.next();
...
class BigRationalUniqueIterator implements Iterator<BigRational> {
    ...
    /**
     * BigRational iterator constructor.
     * @param rit, true for indicator for a non-negative iterator, fall for an
     *            all iterator
     */
