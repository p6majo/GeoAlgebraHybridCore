...
import com.p6majo.core.cas.structure.AbelianGroupElem;
import com.p6majo.core.cas.structure.AbelianGroupFactory;
...
public abstract class ExpVector implements AbelianGroupElem<ExpVector> {
    ...
    public String toString(String[] vars) {
        ...
        int r = length();
        if (r != vars.length) {
            //com.p6majo.logger.warn("length mismatch " + r + " <> " + vars.length);
            return toString();
        }
        if (r == 0) {
            return s.toString();
