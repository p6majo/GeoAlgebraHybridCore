...
import com.p6majo.core.cas.vector.BasicLinAlg;
...
public class TermOrderOptimization {
    ...
    private static final Logger logger = new Logger(TermOrderOptimization.class);
    ...
    public static List<Integer> optimalPermutation(List<GenPolynomial<BigInteger>> D) {
        ...
        if (logger.isDebugEnabled()) {
            logger.log(Logger.Level.info,"V = " + V);
        }
