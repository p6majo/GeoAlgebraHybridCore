...
import com.p6majo.core.cas.arith.ModIntegerRing;
import com.p6majo.core.cas.kern.PreemptStatus;
...
import com.p6majo.core.cas.util.CartesianProduct;
import com.p6majo.core.cas.util.CartesianProductInfinite;
import com.p6majo.core.cas.util.LongIterable;
...
public class GenPolynomialRing<C extends RingElem<C>> implements RingFactory<GenPolynomial<C>>,
    ...
    /**
     * Log4j com.p6majo.logger object.
     */
   private final static Logger logger = new Logger(GenPolynomialRing.class);
    ...
    public GenPolynomial<C> parse(Reader r) {
        ...
        try {
            ...
            logger.log(Logger.Level.warning,e.toString() + " parse " + this);
            p = ZERO;
        }
        return p;
    }
    ...
    public Iterator<GenPolynomial<C>> iterator() {
        ...
        logger.log(Logger.Level.warning,"ring of coefficients " + coFac
