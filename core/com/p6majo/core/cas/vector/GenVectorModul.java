...
import com.p6majo.core.cas.structure.ModulFactory;
...
public class GenVectorModul<C extends RingElem<C>> implements ModulFactory<GenVector<C>, C> {
    ...
    private static final Logger logger =new Logger(GenVectorModul.class);
    ...
    public GenVectorModul(RingFactory<C> b, int s) {
        ...
        logger.log(Logger.Level.info,cols + " module over " + coFac + "constructed");
    }
