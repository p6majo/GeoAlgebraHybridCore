...
import com.p6majo.core.cas.structure.AlgebraFactory;
...
public class GenMatrixRing<C extends RingElem<C>> implements AlgebraFactory<GenMatrix<C>, C> {
    ...
    private static final Logger logger = new Logger(GenMatrixRing.class);
    ...
    public GenMatrixRing(RingFactory<C> b, int r, int c, int s) {
        ...
        logger.log(Logger.Level.info,rows + " x " + cols + " with blocksize " + blocksize + " matrix ring over "
