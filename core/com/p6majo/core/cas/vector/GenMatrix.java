...
import com.p6majo.core.cas.structure.AlgebraElem;
...
public class GenMatrix<C extends RingElem<C>> implements AlgebraElem<GenMatrix<C>, C> {
    ...
    private static final Logger logger =new  Logger(GenMatrix.class);
    ...
    public GenMatrix(GenMatrixRing<C> r, List<List<C>> m) {
        ...
        logger.log(Logger.Level.info,ring.rows + " x " + ring.cols + " matrix constructed");
    }
