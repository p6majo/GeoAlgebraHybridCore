...
import com.p6majo.core.cas.structure.ModulElem;
...
public class GenVector<C extends RingElem<C>> implements ModulElem<GenVector<C>, C> {
    ...
    private static final Logger logger = new Logger(GenVector.class);
    ...
    public GenVector(GenVectorModul<C> m, List<C> v) {
        ...
        modul = m;
        val = v;
        logger.log(Logger.Level.info,modul.cols + " vector constructed");
    }
